...
---- added by nekothefox25

=head1 Build Dependancies

debian/Ubuntu/Linux Mint

build-essential perl flex bison libreadline-dev libncurses-dev libffi-dev libgmp-dev zlib1g-dev libssl-dev

fedora

gcc make perl flex bsion readline-devel ncurses-devel libffi-devel gmp-devel zlib-devel openssl-devel valgrind doxygen graphviz

manjaro Linux

base-devel perl flex bison readline ncurses libffi gmp zlib openssl valgrind doxygen graphviz
